...
function QuestTemplate() {
  const quests = QuestData.map((quest, index) => (
    <div key={index}>
      ...
      <MarqueeButton href={quest.webUrl} label="Live Demo" hasMarquee className="btn-sm" />
      <MarqueeButton href={quest.gitHubUrl} label="GitHub" hasMarquee className="btn-sm" />
      <br />
