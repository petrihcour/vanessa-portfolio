...
const QuestData = [
    {
        ...
        description: "Manage reservations and tables for a restaurant. Built with React, Bootstrap, CSS, Node.js, Express, Postgres, REST APIs",
    ...
    {
        name: "WeLoveMovies", 
        description: "Movie application backend using Node.js, Express, Postgres, and REST APIs, granting access to movie, theater, and review data",
    ...
    },
    {
        ...
        description: "Flashcard application using React and Bootstrap, allowing teachers to create decks of flashcards for students to study",
        imageUrl: flashcard,
    ...
    {
        name: "ThinkfulBnB", 
        description: "Static AirBnB look-a-like, utilizing HTML and CSS Flexbox, focusing on a mobile-first responsive approach",
