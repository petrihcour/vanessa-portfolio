...
function Quests() {
    ...
    return (
        <div id="quests" className="container">
            ...
            <p className="text-center pb-3 body-text text-uppercase">These quests are a large part of my adventures, showcasing my expertise through tangible examples of my work. They serve as a testament to my ability to confront intricate challenges, adapt to different technologies, and efficiently work these projects to completion.</p>
            <QuestTemplate />
        </div>
    )
}
