      ...
      <div className="row">
        <div className="col-lg-7">
          ...
          <div className="text-uppercase body-text">
            ...
            background in leadership, project management, and problem solving
            with software development, bringing a unique mixture of skills and
            perspective. I've got an admiration for technology, an excitement
            for building meaningful connections, and a desire to deliver
            impactful results. Reach out to me and let's weave the magic of
            technology to create experiences that reverberate across the
            internet.
          </div>
        </div>
